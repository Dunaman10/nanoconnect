    ...
    return new Response(json, {
      headers: {
        ...
        pagesFunctionResponse = onRequest;
            ...
            if(!matchedFunc && '/stat-cache' === urlInfo.pathname && request.method === 'GET') {
              matchedFunc = true;
                (() => {
  // edge-functions/stat-cache/index.js
  async function onRequestGet({ request, params, env }) {
    const headers = {
      "Content-Type": "application/json",
      ...
      return new Response(JSON.stringify({
        ...
        headers
          ...
          pagesFunctionResponse = onRequestGet;
            ...
            if(!matchedFunc && '/stat-cache' === urlInfo.pathname && request.method === 'POST') {
              matchedFunc = true;
                (() => {
  // edge-functions/stat-cache/index.js
  async function onRequestGet({ request, params, env }) {
